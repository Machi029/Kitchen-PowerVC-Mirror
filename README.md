...
Port for PowerVC support by Machi Hoshino 
...
#### BDMv2 Support
Supports [BDMv2] (https://docs.openstack.org/developer/nova/block_device_mapping.html#block-device-mapping-v2) format disk datas.
Addtionally PowerVC supports attaching the same disk to multiple instances with using the same uuid. 
